...
import { dataFilterAtom, tableDataAtom, tableFieldsAtom } from '../../_libs/store';
        ...
        <div className="w-[320px]">
            ...
            >
                ...
                <div className="mt-6 flex items-center justify-end space-x-2">
                    <Button
                        className="h-8 flex-1 rounded bg-n7/60 text-sm text-n2 hover:bg-n7/80 hover:text-n2/80 dark:bg-n7"
                        onClick={e => {
                            e.preventDefault();
                            onHide();
                        }}
